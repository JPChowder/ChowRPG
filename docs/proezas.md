...
/// html | div[style='float: left; width: 45%;']
**Intimidação**:
Intuitivamente, esta *proeza* é usada para convencer usando o medo. Ela pode ser usada para intimidar opositores e conseguir melhores situações em um combate ou para aterrorizar pessoas das quais você quer algo que elas resistem em entregar.

**Negociação**:
Não apenas útil para quando se gasta dinheiro,
///

/// html | div[style='float: right; width: 45%;']
*negociação* também pode ser usada quando se negocia para receber pagamento ou para chegar a um acordo sobre alguma situação onde ambas as partes estão entregando algo.

**Persuasão**:
Persuadir alguém vai além de pedir um favor, mas pode envolver exigir rendição ou impor trocas, qualquer coisa que exija convencimento.
///
