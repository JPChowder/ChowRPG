...
Os milagres dos Divinos tem efeitos e áreas bem definidos, isso vem do fato deles serem um poder de uma divindade conjurado por meio de um servo que não tem controle desse poder, ele é apenas o catalisador da sua manifestação. A seguir temos a lista de milagres de cada divindade

**Milagres da Luz**

| Milagre  | Custos |
| :------- | :----: |
| Arma de Luz         | 2 de graça + 2 por ataque extra |
| Raio de Luz         | 3 de graça |
| Armadura Radiante   | 4 de graça + 3 por turno extra |
| Flash               | 5 de graça + 3 por turno extra |
| Brilho Hipnotizante | 9 de graça + 5 por turno extra |
| Onda Luminosa       | 8 de graça |
| Raio de Sol         | 15 de graça |

**Milagres das Trevas**

| Milagre  | Custos |
| :------- | :----: |
| Obscurecer      | 2 de graça + 2 por turno extra |
| Cegueira        | 3 de graça + 1 por turno + 2 por área |
| Escuridão       | 4 de graça + 2 por turno + 2 por área |
| Forma de Sombra | 5 de graça + 1 por metro extra de deslocamento |
| Sono            | 8 de graça + 4 por turno + 6 por área |
| Clone Sombrio   | 9 de graça + 5 por clone extra |
| Mimica Sombria  | 12 de graça + 4 por alvo extra |

**Milagres da Vida**

| Milagre  | Custos |
| :------- | :----: |
| Esporos Infecciosos  | 3 de graça + 2 por turno extra |
| Raízes Entrelaçantes | 4 de graça + 2 por turno + 3 por área |
| Cura                 | 5 de graça |
| Velocidade da Presa  | 5 de graça + 4 por turno extra |
| Ferocidade Predadora | 6 de graça + 3 por turno extra |
| Forma de Predador    | 10 de graça + 5 de vida |
| Rugido Aterrorizante | 12 de graça + 5 por turno extra |
...
=== "Milagres da Luz"
    ...
    **Brilho Hipnotizante**: Uma luz hipnotizante brilha na mão do milagreiro e todos num cone de base 3 a frente dele são atacados em sua defesa de VONTADE. Quem for atingido fica ATORDOADO e caminha em direção ao conjurador 1m por turno que esteja sob o efeito.

    **Onda Luminosa**: Aponta para um alvo a até 10m de distância, amigo ou inimigo, e faz emanar dele uma onda de energia luminosa que ataca a defesa de FORTALEZA de todos ao redor. Causa CARISMA + 3 de dano radiante.

    **Raio de Sol**: Faz com que do céu parta um concentrado raio de luz que atinge uma área de 3x3 com o centro a até 10m do conjurador. Inimigos nesta área são atacados na defesa de FORTALEZA e se atingidos recebem nível + CARISMA dano radiante, caso o ataque falhe os alvos recebem metade do dano. Deve-se estar em um ambiente aberto para conjurar.
...
=== "Milagres das Trevas"
    ...
    **Mímica Sombria**: Faz com que sua sombra e a de um alvo a até 5m se liguem e ele seja forçado a imitar todas as suas ações por até 3 turnos. Ataca a defesa de VONTADE e alvos extra devem estar a até 5m de algum outro alvo.
...
=== "Milagres da Vida"
    ...
    **Velocidade da Presa**: Com um toque concede +4 metros de movimentação para um alvo. Aliados buffados não provocam ataques de oportunidade por movimentação e recebem vantagem menor se correrem antes de atacar um inimigo.
